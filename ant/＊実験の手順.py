...
"画面の構成は以下のようになっています。")
image = Image.open('https://github.com/meg-github/hatena_gui_ant/blob/main/ant/fig_exp2.png?raw=true')
...
image2 = Image.open('https://github.com/meg-github/hatena_gui_ant/blob/main/ant/fig_exp3.png?raw=true')
