...
"3. 質問の回答にはgoogleアカウントへのログインが必要です。googleアカウントを作成し，ログインした状態で回答してください。このログインは重複回答を避けるためのものです。メールアドレスなどの個人情報の収集は行っていません。"
"4. 質問の入力後は必ず「送信」ボタンを押してください。送信後に回答の編集はできません。"
"5. 「送信」を押した後に表示される確認番号は，報酬の獲得に必要です(下の画像のように表示されます)。必ずメモなどで記録しておいてください。"
